...
extension WalletClient {
    ...
    ) -> AnyPublisher<CreateTestModeInvoiceOutput, Error> {
        let variables: [AnyHashable: Any?] = [
            "amount_msats": amountMSats,
            "memo": memo,
    ...
    public func createTestModeInvoice(
        ...
        memo: String? = nil,
        invoiceType: InvoiceType? = nil,
        completion: @escaping (CreateTestModeInvoiceOutput?, Error?) -> Void
    ) {
        let variables: [AnyHashable: Any?] = [
            "amount_msats": amountMSats,
            "memo": memo,
    ...
    public func createTestModeInvoice(
        ...
        memo: String? = nil,
        invoiceType: InvoiceType? = nil
    ) async throws -> CreateTestModeInvoiceOutput {
        let variables: [AnyHashable: Any?] = [
            "amount_msats": amountMSats,
            "memo": memo,
            "invoice_type": invoiceType
    ...
    public func createTestModePaymentPublisher(
        ...
        amountMSats: Int64?,
        signingKey: SecKey
    ) -> AnyPublisher<CreateTestModePaymentoutput, Error> {
        var variables: [AnyHashable: Any] = [
    ...
    public func createTestModePayment(
        ...
        amountMSats: Int64?,
        signingKey: SecKey,
        completion: @escaping (CreateTestModePaymentoutput?, Error?) -> Void
    ) {
        var variables: [AnyHashable: Any] = [
            "encoded_invoice": encodedPaymentRequest,
        ]
    ...
    public func createTestModePayment(
        ...
        amountMSats: Int64?,
        signingKey: SecKey
    ) async throws -> CreateTestModePaymentoutput {
        var variables: [AnyHashable: Any] = [
            "encoded_invoice": encodedPaymentRequest,
        ]
        if let amountMSats = amountMSats {
